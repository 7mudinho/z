    ...
    if (e.keyCode == 9) {
      ...
      switch (cmd) {
        case 'ls':
          ...
          break;
        case 'socials':
              output("choose a number <br><br>[1] instagram <br>[2] twitter <br>[3] discord");
        break;     
          case '1':
          window.open("https://instagram.com/7mudinho", "_blank");                    
          break;
          case '2':
          window.open("https://twitter.com/ddddd285179068", "_blank");                    
          break;
          case '3':
          window.open("https://discord.com/users/1010623861512994938", "_blank");                    
          break;
        case 'play':
